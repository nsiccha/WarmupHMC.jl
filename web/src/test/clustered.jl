...
#
# Runnable standalone (`julia --project test/clustered.jl`) or via runtests.jl.
using WarmupHMC, LogDensityProblems, LinearAlgebra, Random, Statistics, Test
...
# --- targets (distinct names from cooperative.jl, both may be include-d) -------
